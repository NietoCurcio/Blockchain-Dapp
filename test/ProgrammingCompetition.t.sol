...
contract ProgrammingCompetitionTest is Test {
    ...
    function test_RegisterProblemAndPrize() public {
        ...
        competition.registerProblem{value: 1 ether}(1, expectedResultsHash, testCases);
    ...
    function test_EvaluateSolution_Incorrect() public {
        ...
        bytes32 expectedResultsHash = keccak256(allResults);
        competition.registerProblem{value: 1 ether}(2, expectedResultsHash, testCases);
    ...
    function test_EvaluateSolution_FailsOnException() public {
        ...
        bytes32 expectedResultsHash = keccak256(allResults);
        competition.registerProblem{value: 1 ether}(3, expectedResultsHash, testCases);
    ...
    function test_Withdraw() public {
        ...
        bytes32 expectedResultsHash = keccak256(allResults);
        competition.registerProblem{value: 1 ether}(4, expectedResultsHash, testCases);
